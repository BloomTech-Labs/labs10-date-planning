...
const Terms = ({ setTermsShowing }) => {
  return (
    <div style={{ marginTop: "2900px", padding: "15px" }}>
      ...
      <p>
        ...
        conditions in full. Do not continue to use Up4's website if you do not
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using Up4's website you consent to the
        use of cookies in accordance with Up4’s privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, Up4 and/or it’s licensors own the intellectual
        property rights for all material on Up4. All intellectual property
        rights are reserved. You may view and/or print pages from
        http://www.up4.life for your own personal use subject to restrictions
      ...
      <ol>
        ...
        <li>
          ...
          areas of the website. Up4 does not screen, edit, publish or review
          Comments prior to their appearance on the website and Comments do not
          reflect the views or opinions ofUp4, its agents or affiliates.
          Comments reflect the view and opinion of the person who posts such
          view or opinion. To the extent permitted by applicable laws Up4shall
        ...
        <li>
          Up4reserves the right to monitor all Comments and to remove any
        ...
        <li>
          You hereby grant to <strong>Up4</strong> a non-exclusive royalty-free
      ...
      <p>
        ...
        Up4; and (d) where the link is in the context of general resource
      ...
      <p>
        No use of Up4’s logo or other artwork will be allowed for linking absent
