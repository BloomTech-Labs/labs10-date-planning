                  ...
                  <GridContainer>
                    <GridItem xs={12} sm={5} md={5} className={classes.mlAuto}>
                      <InfoArea
                        ...
                        description={
                          <p>
                            Find shows near you according to your tastes and get
                            notified when your favorite performers are in town.
                          </p>
                        }
                        icon={MusicNote}
                        iconColor="rose"
                      ...
                      <InfoArea
                        ...
                        description={
                          <p>
                            Get the scoop on nearby comedy and theatrical events
                            as well as other kind of live performances.
                          </p>
                        }
                        icon={TheaterMasks}
                        iconColor="primary"
                      ...
                      <InfoArea
                        ...
                        description={
                          <p>
                            ...
                            restaurant grand openings or prix fixe events.
                          </p>
                        }
                        icon={Restaurant}
                        iconColor="info"
