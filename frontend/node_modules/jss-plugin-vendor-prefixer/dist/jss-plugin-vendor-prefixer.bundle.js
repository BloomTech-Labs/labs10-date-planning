...
function cloneStyle(style) {
  ...
  if (global$1$1.CSSStyleValue && style instanceof global$1$1.CSSStyleValue) {
    return style;
...
function toCss(selector, style, options) {
  ...
  if (fallbacks) {
    ...
    if (Array.isArray(fallbacks)) {
      for (var index = 0; index < fallbacks.length; index++) {
        ...
        for (var prop in fallback) {
          ...
          if (value != null) {
            ...
            result$$1 += "" + indentStr(prop + ": " + toCssValue(value) + ";", indent);
          }
        }
      }
    } else {
      ...
      for (var _prop in fallbacks) {
        ...
        if (_value != null) {
          if (result$$1) result$$1 += '\n';
          result$$1 += "" + indentStr(_prop + ": " + toCssValue(_value) + ";", indent);
        }
      }
    }
  }
  ...
  for (var _prop2 in style) {
    ...
    if (_value2 != null && _prop2 !== 'fallbacks') {
      if (result$$1) result$$1 += '\n';
      result$$1 += "" + indentStr(_prop2 + ": " + toCssValue(_value2) + ";", indent);
    }
  } // Allow empty style in this case, because properties will be added dynamically.


  if (!result$$1 && !options.allowEmpty) return result$$1; // When rule is being stringified before selector was defined.

  if (!selector) return result$$1;
  indent--;
  if (result$$1) result$$1 = "\n" + result$$1 + "\n";
  return indentStr(selector + " {" + result$$1, indent) + indentStr('}', indent);
}
...
function jssVendorPrefixer() {
  ...
  function onProcessStyle(style, rule) {
    ...
    for (var prop in style) {
      ...
      var supportedValue = lib_1(supportedProp, toCssValue(value));
  ...
  function onChangeValue(value, prop) {
    return lib_1(prop, toCssValue(value)) || value;
  }
